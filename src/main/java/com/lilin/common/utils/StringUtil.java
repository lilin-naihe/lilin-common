...
public class StringUtil {
	...
	public static String randomChineseString(){
		...
		h=(176+Math.abs(random.nextInt(40)));
		random=new Random();
		l=161+Math.abs(random.nextInt(95));
		byte[] b=new byte[2];
	...
	public static String generateChineseName(){
		...
		String n1=str[RandomUtil.random(0, str.length-1)];
		String n2=randomChineseString(RandomUtil.random(1, 2));
		return n1+n2;
	}
